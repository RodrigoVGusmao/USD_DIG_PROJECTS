...
/** Para jogar a versão de texto execute velha.Main.java **/
...
public class JanelaMain extends Shell {
	...
	private static JanelaAnalisePartida historico;
	...
	public static void main(String args[]) {
		try {
			...
			historico = new JanelaAnalisePartida(shell, 0);
	...
	public JanelaMain(Display display) {
		...
		btnAnalisarHistoricoDe.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				historico.open();
			}
