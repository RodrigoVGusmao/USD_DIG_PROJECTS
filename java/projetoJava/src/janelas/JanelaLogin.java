...
public class JanelaLogin extends Dialog {
	 ...
	 * @param style
	 */
	public JanelaLogin(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
		result = null;
	}
	...
	private void createContents() {
			...
			public void widgetSelected(SelectionEvent e) {
				if(camposValidos())
				{
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "Não foi conectar ao banco de dados!" + "\nErro: " + e1.getMessage(),
		...
		btnCadastro.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				JanelaCadastro cadastro = new JanelaCadastro(getParent(), 0);
